package com.fayda.auth.error;

import com.fayda.auth.dto.ErrorResponseDTO;
...
public class ErrorHandler {
  ...
  public ResponseEntity<ErrorResponseDTO> handleGenericError(Throwable err) {
    return handle(err.getMessage(), 409);
  }
